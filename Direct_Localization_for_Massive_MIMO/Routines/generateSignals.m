function [ receivedSignals, signalAfterMF, startIndex ] = generateSignals( sensorsLocs, carrierFreq, bandwidth, oversamplingFactor, noisePower, numSamples, TOAs, AOAs, compAmpli )
    ...
    for l=1:numBS
        ...
        for i=1:length(TOAs{l})
            receivedSignals{l} = receivedSignals{l} +compAmpli{l}(i)...
                *angleToSteering(sensorsLocs{l},AOAs{l}(i),carrierFreq)...
