...
N_transmit=256; % number of transmit antenna
N_receive=256; % number of receive antenna
a=0.5; % the antenna space/ wavelength
MC=20; % monte carlo times
...
%         %% sensing
%         %===========fusion sensing===============
%         [MBS_delay,MBS_AoA]=threeD_MUSIC(three_dimentional_all_MBS_noise,N_receive,Nc,c_0,delta_f2);
% 
%         %% calculating the location
%         %=========== fusion ==================
%         [tarMBS_1,tarMBS_2,tarMBS_3]=AoA_location(MBS_location,MiBS_location,MBS_delay,MBS_AoA);
%         [tarMBS_1,tarMBS_2,tarMBS_3]=grid_3D_DFT(three_dimentional_all_MBS_noise,N_receive,Nc,delta_f2,c_0,MBS_location,MiBS_location);
          [tarMBS_1,tarMBS_2,tarMBS_3]=threeD_DFT(three_dimentional_all_MBS_noise,c_0,delta_f2,N_receive,Nc,MBS_location,MiBS_location);
          RMSE1=RMSE1+((tarMBS_3(1)-target_3(1))^2+(tarMBS_3(2)-target_3(2))^2+ ...
            (tarMBS_2(1)-target_2(1))^2+(tarMBS_2(2)-target_2(2))^2+ ...
            (tarMBS_1(1)-target_1(1))^2+(tarMBS_1(2)-target_1(2))^2)/3;
    end
    toc
